        ...
        <div class="flex flex-col sm:flex-row mt-10">
          <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
            <div class="flex flex-col items-center text-center justify-center">
              <h2 class="font-medium title-font text-gray-900 text-lg">Medicare.TN</h2>
              <div class="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
              <p class="text-base">
                How it works ? it is very simple ! All you need to do is create a care request with a Health specialist by clicking on (Make an appointment). <br>
                Once your care request has been created, it is sent to the Health specialists closest to you. <br> 
                As soon as a Health specialist validates the care, you are put in contact.
              </p>
            </div>
          </div>
          <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
            <p class="leading-relaxed text-lg mb-4">
              Our web platform "MediCare.tn", offers patients, the elderly, bedridden people, or other people wishing to have medical assistance at home, an address book of the health professionals closest to them. <br>
