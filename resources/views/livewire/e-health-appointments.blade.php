                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Patient Email</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($data->whereIn('related_id', auth()->user()->id) as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-2 text-xs capitalize">{{ $item->patient_email }}</td>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="user_email" class="block mt-1 w-full" type="email" wire:model.debounce.800ms="patient_email" />
