    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="specialty" value="{{ __('Specialty') }}"/>
                <select id="specialty" wire:model.defer="state.specialty" name="specialty" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md">
